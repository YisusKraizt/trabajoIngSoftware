 ...
 * @author Carlos
 */
public class BuscarRecetaSinLogin extends HttpServlet {
      ...
      ArrayList<Receta> listaRecetas = new ArrayList<Receta>();
            ...
            while(rs.next()){
             ...
             if (listaRecetas.isEmpty()){
                    ...
                    rs.close();
                response.sendRedirect(request.getContextPath()+"/jsp/errorsinlogin.jsp");
                }
            session.setAttribute("consulta", listaRecetas);

            response.sendRedirect(request.getContextPath()+"/jsp/mostrarRecetaFiltrosinlogin.jsp");
 rs.close();
            }//fin for
