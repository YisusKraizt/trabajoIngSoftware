 ...
 * @author Carlos
 */
public class SeleccionarPorCategoria extends HttpServlet {
...
//            String query = "select r.idreceta, r.nombre, t.Tipo"
//                    + " from receta r, TipoPlato t"
//                    + " where r.TipoPlato_idTipoPlato=t.idTipoPlato and t.Tipo='" + categoria + "';";
            String query = "select r.idreceta, r.nombre, r.provincia, t.tipo, r.precio, v.url"
                    + " from receta r, tipoplato t, video v"
                    + " where r.idtipoplato=t.idtipoplato and v.idvideo=r.idvideo and t.tipo='" + categoria + "';";
