...
public class SeleccionarPorProvincia extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            System.out.println("state: " + provincia);
...
//
                    ...
                    + " where r.idtipoplato=t.idtipoplato and v.idvideo=r.idvideo and r.provincia='" + provincia + "';";
          ...
          while(rs.next()){
             ...
             if (listaRecetas.isEmpty()){
                    session.setAttribute("criterio", "Provincia");
                    session.setAttribute("valor", provincia);
                    rs.close();
