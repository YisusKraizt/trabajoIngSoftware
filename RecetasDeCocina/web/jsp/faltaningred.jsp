<%-- 
    Document   : faltaningred
    Created on : 17-ene-2011, 21:16:21
    Author     : USUARIO
--%>
    ...
    <table width="100%" height="571" border="1">
      ...
      <tr bgcolor="#CCFFFF">
        ...
        <td width="78%" valign="top"><p>&nbsp;</p>
              ...
              <form method="post" action="<%= response.encodeRedirectURL(request.getContextPath()+"/jsp/introduciringrediente.jsp")%>">
